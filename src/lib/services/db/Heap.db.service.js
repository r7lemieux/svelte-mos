...
var HeapDbService = /** @class */ (function () {
    function HeapDbService() {
        var _this = this;
        this.records = {};
        this.getMo = function (moDef, key) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.records[moDef.dbName][key]];
            });
        }); };
        ...
        this.getMos = function (moDef) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Object.values(this.records[moDef.dbName])];
            });
        }); };
