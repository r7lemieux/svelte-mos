...
var ValidationService = /** @class */ (function () {
    function ValidationService() {
        ...
        this.key = function (str, len) {
            ...
            if (!valid) {
                return new rezult_1.Rezult(errorName_1.ErrorName.db_invalid_key, { key: str });
            }
            return null;
        };
        ...
        this.int = function (options) {
            ...
            var validateMinMax = function (value) {
                if (value < min) {
                    return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_numberTooSmall, { value: value, min: min });
                }
                if (max && value > max) {
                    return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_numberTooLarge, { value: value, max: max });
                }
                return null;
            };
            return {
                parse: function (str) {
                    ...
                    if (!_this.intRegex.test(str)) {
                        throw new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_number, { str: str });
                    }
                ...
                validate: function (value) {
                    ...
                    if (!Number.isSafeInteger(value)) {
                        return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_number, { value: value });
                    }
                ...
                validateString: function (str) {
                    ...
                    if (!_this.intRegex.test(str)) {
                        return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_number, { value: str });
                    }
                    var value = parseInt(str);
                    return validateMinMax(value);
                }
            ...
            return {
                parse: function (str) {
                    ...
                    if (value > _this.maxInt) {
                        throw new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_numberTooLarge, { str: str });
                    }
                    return value;
                },
                validate: function (value) {
                    ...
                    if (value < 0) {
                        return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_numberTooSmall, { value: value, min: 0 });
                    }
                    if (value > _this.maxInt) {
                        return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_numberTooLarge, { value: value, max: _this.maxInt });
                    }
                    return null;
                },
                validateString: function (str) {
                    ...
                    if (!_this.idRegex.test(str)) {
                        return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_number, { str: str });
                    }
                    var value = parseInt(str);
                    if (value > _this.maxInt) {
                        return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_numberTooLarge, { str: str });
                    }
                    return null;
                }
            };
        ...
        this.validateEmail = function (value) {
            ...
            if (!re.test(value)) {
                return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid_email, { value: value });
            }
            return null;
        };
        this.email = {
        ...
        this.buildText = function (regexStr, minlen, maxlen) {
            return {
                ...
                validate: function (value) {
                    ...
                    if (!regex.test(value)) {
                        return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid, { value: value });
                    }
                    return null;
                }
            };
        ...
        this.name = {
            ...
            validate: function (value) {
                ...
                if (!regex.test(value)) {
                    return new rezult_1.Rezult(errorName_1.ErrorName.field_invalid, { value: value, format: { min: 2, max: 40, first: 'character', content: ['character', 'space', '-'] } });
                }
                return null;
            }
        };
